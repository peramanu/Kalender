      ...
      <main className="min-h-screen flex flex-col justify-center px-5 py-12">
        ...
        <div className="w-full max-w-sm mx-auto text-center">
          ...
          <p className="text-white/60 text-sm leading-relaxed mb-2">
            ...
            <span className="text-white font-medium">{email}</span> geschickt.
          </p>
          <p className="text-white/40 text-xs mb-6">
            Klicke auf den Link in der E-Mail um dein Konto zu aktivieren.
            Kein E-Mail erhalten? Schau im Spam-Ordner nach.
          </p>
          <Link
            href="/login"
    ...
    <main className="min-h-screen flex flex-col justify-center px-5 py-12">
      ...
      <div className="w-full max-w-sm mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-white/50 text-sm mt-1">Kostenlos — keine Kreditkarte nötig</p>
        </div>
