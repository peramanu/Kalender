    ...
    <main className="min-h-screen flex flex-col justify-center px-5 py-12">
      ...
      <div className="w-full max-w-sm mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/50 text-sm mt-1">Melde dich bei deinem Konto an</p>
        </div>
        ...
        <button
          ...
          className="w-full border border-white/10 bg-white/5 hover:bg-white/10 active:bg-white/15 rounded-xl py-3.5 text-white/80 text-sm font-medium transition-all flex items-center justify-center gap-2.5 mb-4 disabled:opacity-50"
        >
          {googleLoading ? (
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-white/30 text-xs">oder mit E-Mail</span>
          <div className="flex-1 h-px bg-white/10" />
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-white/70 text-sm font-medium">Passwort</label>
                <Link href="/forgot-password" className="text-indigo-400 text-xs hover:text-indigo-300">
                  Vergessen?
                </Link>
              </div>
              <div className="relative">
            ...
            <button
              ...
              className="w-full bg-indigo-500 hover:bg-indigo-400 active:bg-indigo-600 disabled:opacity-50 text-white font-semibold py-3.5 rounded-xl transition-all text-base mt-2 flex items-center justify-center gap-2"
            >
