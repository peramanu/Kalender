      ...
      <div className="w-full max-w-sm mx-auto">
        ...
        <div className="glass rounded-2xl p-6 space-y-4">
          ...
          <button
            ...
            className="w-full border border-white/10 bg-white/5 active:bg-white/10 rounded-xl py-3.5 text-white/80 text-sm font-medium transition-all flex items-center justify-center gap-2.5"
          >
