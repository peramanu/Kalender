        ...
        <div className="glass rounded-glass-xl p-8">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-indigo-500 hover:bg-indigo-400 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-glass transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
          ...
          {/* OAuth */}
          <button className="w-full glass-hover border border-white/10 rounded-glass py-3 text-white/70 hover:text-white text-sm font-medium transition-all flex items-center justify-center gap-2">
